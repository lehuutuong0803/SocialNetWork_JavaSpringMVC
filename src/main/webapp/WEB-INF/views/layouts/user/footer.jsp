...
<div class="bottombar">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<span class="copyright">© Hutech University 2020. All rights reserved.</span>
	...
	<div class="side-panel">
		...
		<form method="post">
			<div class="setting-row">
				<span>Sử dụng chế độ ban đêm</span>
			...
			<div class="setting-row">
				<span>Trình hồ sơ</span>
				<input type="checkbox" id="switch55" /> 
				<label for="switch55" data-on-label="ON" data-off-label="OFF"></label>
			</div>
		</form>
		<h4 class="panel-title">Thiết lập tài khoản</h4>
		<form method="post">
			<div class="setting-row">
			...
			<div class="setting-row">
				<span>Tài khoản kinh doanh</span>
				<input type="checkbox" id="switch88" /> 
				<label for="switch88" data-on-label="ON" data-off-label="OFF"></label>
			</div>
			<div class="setting-row">
				<span>Cho tôi xem trực tuyến</span>
		...
		<div class="popup post-sharing">
			...
			<div class="popup-meta">
				...
				<div class="postbox">
					...
					<figure><img src="..//assets/images/resources/share-post.jpg" alt=""></figure>
					<div class="friend-info">
						<figure>
							<img alt="" src="..//assets/images/resources/admin.jpg">
						</figure>
